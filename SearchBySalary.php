...
<html>
    ...
    <form action="SalaryTable.php" class="search-bar" method="POST">
    <div class="numR">
    <label for="num">Number of records:</label>
   
    <input type="text" id="num" name="num" value="100">
    </div>
	<input type="search"  pattern=".*\S.*" name="first_name" placeholder="Enter Range Salary eg min(65000) – max(70000)" required >
